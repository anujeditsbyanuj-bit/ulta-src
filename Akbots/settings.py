...
def get_settings_buttons():
    if BUTTON_STYLE_SUPPORTED:
        ...
        return InlineKeyboardMarkup([
            ...
            [make_button(" 🎬 ᴇɴᴄᴏᴅɪɴɢ sᴇᴛᴛɪɴɢs ", callback_data="encset:root", icon_custom_emoji_id=ICON_EDIT)],
            ...
            [make_button(" 🚀 1 ᴍᴀɴᴀɢᴇʀ ", callback_data="akmanager_btn", icon_custom_emoji_id=ICON_LIST)],
